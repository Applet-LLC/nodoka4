...
///
enum NodokaDialogType
{
	NodokaDialogType_investigate = 0x10000, ///
	NodokaDialogType_log = 0x20000,			///
	NodokaDialogType_mask = 0xffff0000,		///
};

/// stream output
extern tostream &operator<<(tostream &i_ost, NodokaDialogType i_data);
...
enum ModifierLockType
{
	...
	ModifierLockType_LockA = Modifier::Type_LockA, ///
	ModifierLockType_LockB = Modifier::Type_LockB, ///
	ModifierLockType_LockC = Modifier::Type_LockC, ///
	ModifierLockType_LockD = Modifier::Type_LockD, ///
	ModifierLockType_LockE = Modifier::Type_LockE, ///
	ModifierLockType_LockF = Modifier::Type_LockF, ///
};
